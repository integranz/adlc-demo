...
This repository is delivered by the **adlc** Claude Code plugin (0.8.2). This file is the routing page for humans and agents: what is here, which skill to run, which rules apply. Procedures live in the plugin's skills, not here.
